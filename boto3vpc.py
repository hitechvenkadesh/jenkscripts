...
region = str(input("Enter the Region_Name: "))
access_key = str(input("Enter the access_key: "))
secret_key = str(input("Enter the secret_key: "))
VPCcidr = str(input("Enter the VPCcidr: "))
SubnetCidr = str(input("Enter the SubnetCidr: "))
SubnetAZ = str(input("Enter the SubnetAZ: "))
VPCname = str(input("Enter the VPCname: "))
Subnetname = str(input("Enter the Subnetname: "))
destcidr = str(input("Enter the destcidr: "))
...
routetableassoc = client.associate_route_table(
...
routeentry = client.create_route(
    RouteTableId=myroutetable['RouteTable']['RouteTableId'],
